...
/**
 *  \file       demande_contact.php
 *  \ingroup    repliclient
 *  \brief      Tab for contacts linked to Demande
 */
...
$title = $langs->trans("Demande")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Demande"), -1, $object->picto);
