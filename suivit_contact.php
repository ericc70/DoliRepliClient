...
/**
 *  \file       suivit_contact.php
 *  \ingroup    repliclient
 *  \brief      Tab for contacts linked to Suivit
 */
...
$title = $langs->trans("Suivit")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Suivit"), -1, $object->picto);
