...
/**
 * 	\defgroup   repliclient     Module RepliClient
 *  \brief      RepliClient module descriptor.
 *
 *  \file       htdocs/repliclient/core/modules/modRepliClient.class.php
 *  \ingroup    repliclient
 *  \brief      Description and activation file for module RepliClient
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module RepliClient
 */
class modRepliClient extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 70000; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module

		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'repliclient';
		...
		// Module label (no space allowed), used if translation string 'ModuleRepliClientName' not found (RepliClient is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// DESCRIPTION_FLAG
		// Module description, used if translation string 'ModuleRepliClientDesc' not found (RepliClient is name of module).
		$this->description = "RepliClientDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "RepliClientDescription";

		// Author
		$this->editor_name = 'Ericc70';
		$this->editor_url = 'https://ericc70.fr';		// Must be an external online web site
		$this->editor_squarred_logo = '';					// Must be image filename into the module/img directory followed with @modulename. Example: 'myimage.png@repliclient'
		...
		// Key used in llx_const table to save module status enabled/disabled (where REPLICLIENT is value of property name of module in uppercase)
		...
		// Example: this->dirs = array("/repliclient/temp","/repliclient/subdir");
		...
		$this->hidden = getDolGlobalInt('MODULE_REPLICLIENT_DISABLED'); // A condition to disable module;
		...
		$this->langfiles = array("repliclient@repliclient");
		...
		//$this->automatic_activation = array('FR'=>'RepliClientWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('REPLICLIENT_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('REPLICLIENT_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isModEnabled("repliclient")) {
			$conf->repliclient = new stdClass();
			$conf->repliclient->enabled = 0;
		}
		...
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@repliclient:$user->hasRight('repliclient', 'read'):/repliclient/mynewtab1.php?id=__ID__');
		// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@repliclient:$user->hasRight('othermodule', 'read'):/repliclient/mynewtab2.php?id=__ID__',
		...
		/* Example:
		 ...
		 'tabcond'=>array(isModEnabled('repliclient'), isModEnabled('repliclient'), isModEnabled('repliclient')),
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in repliclient/core/boxes that contains a class to show a widget.
		/* BEGIN MODULEBUILDER WIDGETS */
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'repliclientwidget1.php@repliclient',
			//      'note' => 'Widget provided by RepliClient',
		...
		$this->cronjobs = array(
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => 'isModEnabled("repliclient")',
			//      'priority' => 50,
			//  ),
		);
		/* END MODULEBUILDER CRON */
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'isModEnabled("repliclient")', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("repliclient")', 'priority'=>50)
		// );
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'repliclient');
		$result = $this->_load_tables('/repliclient/sql/');
		if ($result < 0) {
		...
		//$result0=$extrafields->addExtraField('repliclient_separator1', "Separator 1", 'separator', 1,  0, 'thirdparty',   0, 0, '', array('options'=>array(1=>1)), 1, '', 1, 0, '', '', 'repliclient@repliclient', 'isModEnabled("repliclient")');
		//$result1=$extrafields->addExtraField('repliclient_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', -1, 0, '', '', 'repliclient@repliclient', 'isModEnabled("repliclient")');
		//$result2=$extrafields->addExtraField('repliclient_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', -1, 0, '', '', 'repliclient@repliclient', 'isModEnabled("repliclient")');
		//$result3=$extrafields->addExtraField('repliclient_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', -1, 0, '', '', 'repliclient@repliclient', 'isModEnabled("repliclient")');
		//$result4=$extrafields->addExtraField('repliclient_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', -1, 0, '', '', 'repliclient@repliclient', 'isModEnabled("repliclient")');
		//$result5=$extrafields->addExtraField('repliclient_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', -1, 0, '', '', 'repliclient@repliclient', 'isModEnabled("repliclient")');
