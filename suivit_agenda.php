...
/**
 *  \file       suivit_agenda.php
 *  \ingroup    repliclient
 *  \brief      Tab of events on Suivit
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Suivit")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Suivit"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_suivit_'.$object->id;
