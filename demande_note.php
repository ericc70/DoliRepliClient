...
/**
 *  \file       demande_note.php
 *  \ingroup    repliclient
 *  \brief      Tab for notes on Demande
 */
...
$title = $langs->trans('Demande').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Demande"), -1, $object->picto);
