...
/**
 *  \file       demande_agenda.php
 *  \ingroup    repliclient
 *  \brief      Tab of events on Demande
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Demande")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Demande"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_demande_'.$object->id;
