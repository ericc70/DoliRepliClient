...
/**
 *  \file       source_note.php
 *  \ingroup    repliclient
 *  \brief      Tab for notes on Source
 */
...
$title = $langs->trans('Source').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-repliclient page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Source"), -1, $object->picto);
